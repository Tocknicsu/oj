...
\begin{document}
    ...
    \begin{center}\section{pG}\end{center}
    \input{./pg.txt}
    \lstinputlisting{./pg.cpp}
    \newpage
    ...
    \begin{center}\section{pK}\end{center}
    \input{./pk.txt}
    \lstinputlisting{./pk.cpp}
    \newpage

    \begin{center}\section{pL}\end{center}
    \input{./pl.txt}
    \lstinputlisting{./pl.cpp}
    \newpage
